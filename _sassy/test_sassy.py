...
class TestSassy:
    ...
    def test_sassy_load_config_ok(self):
        ...
        sassy = sas.Sassy(apps='test_sassy')
    ...
    def test_create_files_and_dirs_success(self):
        ...
        patcher = patch('sassy.Sassy.create_dir')
    ...
    def test_create_file_already_exist(self):
        ...
        patcher = patch('sassy.os.path.isfile')
    ...
    def test_create_file_success_with_dir_name(self):
        ...
        with patch('sassy.open', mock_open()) as mocked_file:
            r = sassy.create_file(
    ...
    def tests_create_dir_already_exist(self):
        sassy = sas.Sassy(apps='test_sassy')
        sassy.update = False
        isdir_patcher = patch('sassy.os.path.isdir')
        mock_isdir = isdir_patcher.start()
        mock_isdir.return_value = True

        makedir_patcher = patch('sassy.os.makedirs')
